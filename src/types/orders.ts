...
export type MakerOrderWithoutNonce = Omit<MakerOrder, 'nonce'>;

export interface MakerOrderWithEncodedParams
  extends Omit<MakerOrder, 'params'> {
  params: BytesLike;
}
...
export interface TakerOrderWithEncodedParams
  extends Omit<TakerOrder, 'params'> {
  params: BytesLike;
}
